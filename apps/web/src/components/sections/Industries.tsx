...
export default function Industries({ industries }: IndustriesProps) {
  /* The marquee runs two copies of the set so the loop has somewhere to scroll
     to. Derived here rather than at module load, because the set comes from the
     CMS now and can change between renders. */
  const N = industries.length;
  const SLIDES = useMemo(() => [...industries, ...industries], [industries]);
