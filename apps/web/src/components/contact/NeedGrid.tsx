...
export interface NeedGridProps {
  services: Service[];
}

export default function NeedGrid({ services }: NeedGridProps) {
  /* Built per render now that the practices come from the CMS. */
  const NEEDS = buildNeeds(services);
