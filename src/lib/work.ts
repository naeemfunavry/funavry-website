...
export const WORK_PROJECTS: WorkProject[] = CASE_STUDY_DETAILS.map(toWorkProject);

export const FEATURED_PROJECTS: WorkProject[] = FEATURED_SLUGS.map((slug) =>
...
export const WORK_PROJECTS_BY_VISUALS: WorkProject[] = [...WORK_PROJECTS].sort(
  (a, b) => Number(b.hasVisuals) - Number(a.hasVisuals),
);
